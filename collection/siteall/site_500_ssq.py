...
def _parse_detail_data(data=None, url=None, **kwargs):
    ...
    open_xpath = root.xpath('//div[@class="ball_box01"]//ul//li//text()')
    code_list = []
    ...
    # print('rool', roll)
    rolling = util.modify_unit(roll[1])
    currentAward = util.modify_unit(roll[0])
    print('this deal')
    ...
    open_time = year + '-' + mon + '-' + day + ' 21:15:00'
    ...
    data_item = {"rolling": "0", "bonusSituationDtoList": [
        ...
        {"winningConditions": "5+1", "numberOfWinners": "0", "singleNoteBonus": "0", "prize": "三等奖"},
        {"winningConditions": "5+0,4+1", "numberOfWinners": "0", "singleNoteBonus": "0", "prize": "四等奖"},
        {"winningConditions": "4+0,3+1", "numberOfWinners": "0", "singleNoteBonus": "0", "prize": "五等奖"},
        {"winningConditions": "2+1,1+1,0+1", "numberOfWinners": "0", "singleNoteBonus": "0", "prize": "六等奖"}],
...
def main(**kwargs):
    ...
    CP = {
        93: 'http://kaijiang.500.com/shtml/ssq/19029.shtml',
    }
    RESULT = {
        93: 'game_ssq_result',
    }
    url = CP[93]
    dlt_list = get_expect('http://kaijiang.500.com/ssq.shtml')
