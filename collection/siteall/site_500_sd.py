...
t = {"rolling": "72.55亿", "bonusSituationDtoList": [
    {"winningConditions": "5+2", "numberOfWinners": "2", "additionNumber": "-", "isSuperAddition": 1,
     "singleNoteBonus": "10,000,000", "additionBonus": "-", "prize": "一等奖"},
    {"winningConditions": "5+1", "numberOfWinners": "42", "additionNumber": "17", "isSuperAddition": 1,
     "singleNoteBonus": "249,760", "additionBonus": "149,856", "prize": "二等奖"},
    {"winningConditions": "5+0,4+2", "numberOfWinners": "491", "additionNumber": "175", "isSuperAddition": 1,
     "singleNoteBonus": "8,506", "additionBonus": "5,103", "prize": "三等奖"},
    {"winningConditions": "4+1,3+2", "numberOfWinners": "19464", "additionNumber": "7254", "isSuperAddition": 1,
     "singleNoteBonus": "200", "additionBonus": "100", "prize": "四等奖"},
    {"winningConditions": "4+0,3+1,2+2", "numberOfWinners": "423952", "additionNumber": "159348", "isSuperAddition": 1,
     "additionBonus": "5", "prize": "五等奖"},
    {"winningConditions": "3+0,1+2,2+1,0+2", "numberOfWinners": "4532215", "isSuperAddition": 1, "singleNoteBonus": "5",
     "prize": "六等奖"}], "nationalSales": "2.13亿", "currentAward": "7042.24万"}
...
def _parse_detail_data(data=None, url=None, **kwargs):
    ...
    if '合计' in sum_list:
        ...
        sum_count = '0'
    data_item['currentAward'] = sum_count
...
def main(**kwargs):
    ...
    CP = {
        ...
        93: 'http://kaijiang.500.com/shtml/sd/2004001.shtml',  # 14052后 就是改版后的页面
